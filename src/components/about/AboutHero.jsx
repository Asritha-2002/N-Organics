...
const AboutHero = () => {
  return (
    <section className="relative overflow-hidden bg-[#faf8f5] pt-28 sm:pt-32 lg:pt-36">
      ...
      <div className="mx-auto max-w-7xl px-4 pb-14 pt-10 text-center sm:px-6 sm:pb-16 lg:px-8 lg:pb-20">
        ...
        <p className="mx-auto mt-5 max-w-2xl text-sm leading-7 text-[#6f6a61] sm:text-base">
          We create thoughtful skincare and haircare experiences inspired by
          nature, gentle rituals, and clean everyday beauty.
        </p>
      </div>
    </section>
  );
