      ...
      <div className="max-w-6xl mx-auto px-4 py-10">
        ...
        <div className="bg-white rounded shadow-sm p-6 md:p-10 space-y-8 text-gray-700 leading-relaxed">
          ...
          <p>
            ...
            <strong> N-Organics </strong> ("we", "us", or "our"). By accessing or using
          ...
          <Section title="5. Intellectual Property">
            <p>
              ...
              is the property of N-Organics or its licensors and is protected by
          ...
          <Section title="8. Limitation of Liability">
            <p>
              To the fullest extent permitted by law, N-Organics shall not be liable for
